import {
    ASYNC_VAULT_V2_ERROR__ARITHMETIC_ERROR,
    ASYNC_VAULT_V2_ERROR__FEE_BPS_EXCEEDED,
    ASYNC_VAULT_V2_ERROR__INVALID_ASSET_MINT,
    ASYNC_VAULT_V2_ERROR__INVALID_FEE_RECIPIENT,
    ASYNC_VAULT_V2_ERROR__INVALID_REQUEST,
    ASYNC_VAULT_V2_ERROR__INVALID_REQUEST_TYPE,
    ASYNC_VAULT_V2_ERROR__INVALID_SHARE_MINT,
    ASYNC_VAULT_V2_ERROR__MINTS_SHOULD_BE_DIFFERENT,
    ASYNC_VAULT_V2_ERROR__NO_PENDING_AUTHORITY,
    ASYNC_VAULT_V2_ERROR__PAUSED_VAULT,
    ASYNC_VAULT_V2_ERROR__REDEMPTION_AMOUNT_BELOW_MINIMUM,
    ASYNC_VAULT_V2_ERROR__REDEMPTION_QUEUE_OUT_OF_ORDER,
    ASYNC_VAULT_V2_ERROR__REDEMPTIONS_PAUSED,
    ASYNC_VAULT_V2_ERROR__REQUEST_NOT_CLAIMABLE,
    ASYNC_VAULT_V2_ERROR__REQUEST_NOT_PENDING,
    ASYNC_VAULT_V2_ERROR__SHARE_MINT_SUPPLY_SHOULD_BE_ZERO,
    ASYNC_VAULT_V2_ERROR__SUBSCRIPTION_AMOUNT_BELOW_MINIMUM,
    ASYNC_VAULT_V2_ERROR__SUBSCRIPTION_QUEUE_OUT_OF_ORDER,
    ASYNC_VAULT_V2_ERROR__SUBSCRIPTIONS_PAUSED,
    ASYNC_VAULT_V2_ERROR__UNAUTHORIZED_SIGNER,
    ASYNC_VAULT_V2_ERROR__UNINITIALIZED_VAULT,
    ASYNC_VAULT_V2_ERROR__VAULT_ALREADY_INITIALIZED,
...
const VAULT_ERROR_MESSAGES: Record<number, string> = {
    [ASYNC_VAULT_V2_ERROR__UNAUTHORIZED_SIGNER]: 'Unauthorized signer',
    [ASYNC_VAULT_V2_ERROR__UNINITIALIZED_VAULT]: 'Vault is not initialized',
    [ASYNC_VAULT_V2_ERROR__PAUSED_VAULT]: 'Vault is paused',
    [ASYNC_VAULT_V2_ERROR__VAULT_ALREADY_INITIALIZED]: 'Vault is already initialized',
    [ASYNC_VAULT_V2_ERROR__FEE_BPS_EXCEEDED]: 'Fee basis points exceed maximum',
    [ASYNC_VAULT_V2_ERROR__ARITHMETIC_ERROR]: 'Arithmetic error',
    [ASYNC_VAULT_V2_ERROR__MINTS_SHOULD_BE_DIFFERENT]: 'Asset and share mints must be different',
    [ASYNC_VAULT_V2_ERROR__SHARE_MINT_SUPPLY_SHOULD_BE_ZERO]: 'Share mint supply must be zero before create',
    [ASYNC_VAULT_V2_ERROR__NO_PENDING_AUTHORITY]: 'No pending authority invitation',
    [ASYNC_VAULT_V2_ERROR__INVALID_FEE_RECIPIENT]: 'Fee recipient account is invalid',
    [ASYNC_VAULT_V2_ERROR__REQUEST_NOT_PENDING]: 'Request is not in a pending state',
    [ASYNC_VAULT_V2_ERROR__REQUEST_NOT_CLAIMABLE]: 'Request is not claimable yet',
    [ASYNC_VAULT_V2_ERROR__INVALID_REQUEST]: 'Request address is not valid',
    [ASYNC_VAULT_V2_ERROR__INVALID_REQUEST_TYPE]: 'Invalid request type for this instruction',
    [ASYNC_VAULT_V2_ERROR__INVALID_ASSET_MINT]: 'Asset mint is not valid',
    [ASYNC_VAULT_V2_ERROR__INVALID_SHARE_MINT]: 'Share mint is not valid',
    [ASYNC_VAULT_V2_ERROR__SUBSCRIPTIONS_PAUSED]: 'Subscriptions are paused',
    [ASYNC_VAULT_V2_ERROR__REDEMPTIONS_PAUSED]: 'Redemptions are paused',
    [ASYNC_VAULT_V2_ERROR__SUBSCRIPTION_AMOUNT_BELOW_MINIMUM]: 'Deposit is below the minimum subscription threshold',
    [ASYNC_VAULT_V2_ERROR__REDEMPTION_AMOUNT_BELOW_MINIMUM]: 'Redemption is below the minimum redemption threshold',
    [ASYNC_VAULT_V2_ERROR__SUBSCRIPTION_QUEUE_OUT_OF_ORDER]: 'Deposit request is not next in the subscription queue',
    [ASYNC_VAULT_V2_ERROR__REDEMPTION_QUEUE_OUT_OF_ORDER]: 'Redeem request is not next in the redemption queue',
};
